  ...
  <section class="modal-dialog">
    <section class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="small"><strong>Always backup your keys: </strong> Roller Platform is not a web application. You do not create an account or give us your funds to hold onto. No data leaves your computer / your browser. We make it easy for you to create, save, and access your information and interact with the blockchain.</p>

        <p class="small"><strong>We are not responsible for any loss: </strong> roller, Roller Platform, and the underlying libraries we use are under active development. There is always the possibility something unexpected happens that causes your funds to be lost. Please do not invest more than you are willing to lose, and please be careful.</p>

        <p class="small"><strong> Offical Text: </strong> The English version of our website is the official text. </p>

        <p class="small"><strong>MIT License</strong> See <a href="https://github.com/roller-project/roller-wallet-web">https://github.com/roller-project/roller-wallet-web for complete licensing information.</a></p>
