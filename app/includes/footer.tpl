<section class="pre-footer">
  <div class="container">
    <p>
      Akroma Web Wallet does not hold your keys for you. We cannot access accounts, recover keys, reset passwords, nor reverse transactions. Protect your keys &amp; always check that you are on correct URL.
...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--righ">
      <p>
        <a aria-label="twitter" title="twitter" href="https://twitter.com/akroma_io" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="medium" title="medium" href="https://medium.com/akroma" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
