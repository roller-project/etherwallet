<section class="pre-footer">
  <div class="container">
    <p>
      Roller Platform does not hold your keys for you. We cannot access accounts, recover keys, reset passwords, nor reverse transactions. Protect your keys &amp; always check that you are on correct URL.
...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      ...
      <p>
        <span>
          Free, open-source, client-side interface for generating Roller Wallets. 
        </span>
      </p>
    ...
    <section class="footer--cent">
      ...
      <a href="/">
        ...
        <p>
           See <a href="https://github.com/roller-project/roller-wallet-web">https://github.com/roller-project/roller-wallet-web for complete licensing information.</a>
        </p>
      </a>
    ...
    <section class="footer--righ">
      <p>
        <a aria-label="twitter" title="twitter" href="https://twitter.com/roller_io" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="medium" title="medium" href="https://medium.com/roller" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="github" title="github" href="https://github.com/roller-project/roller-wallet-web" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
