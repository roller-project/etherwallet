...
TXFEE_Desc                  : 'La comissió per la TX es paga als miners per incloure la teva TX en un block. És el `límit de gas` * `preu del gas`. [Pots convertir GWEI -> ETH aquí](https://mew.roller.today/helpers.html)',
...
NAV_SendEther               : 'Envia roller & Tokens ',
...
/* General */
x_Access                    : 'Accedir ',
x_AddessDesc                : 'La teva adreça també pot ser anomenada `# de compte` o `Clau Pública`. És el que comparteixes amb la gent perquè puguin enviar-te roller o Tokens. Cerqueu la icona d\'adreça de colors. Assegura\'t que coincideixi amb la vostra cartera de paper i quan introduïu la vostra adreça en algun lloc.',
x_Address                   : 'La teva adreça ',
x_Cancel                    : 'Cancel·lar ',
x_CSV                       : 'Fitxer CSV (no xifrat) ',
x_Download                  : 'Descarregar ',
x_Json                      : 'Fitxer JSON(no xifrat) ',
x_JsonDesc                  : 'Aquesta és la teva clau privada no xifrada, en format JSON. Això significa que no necessites la contrasenya, però qualsevol que trobi el JSON pot accedir a la teva cartera i roller sense la contrasenya. ',
...
/* Header */
CX_Tagline                  : 'Cartera d\'roller de codi obert programada amb JavaScript executada en el client com a extensió de Chrome ',
...
MEW_Tagline                 : 'Cartera d\'roller de codi obert programada amb JavaScript ',
...
ADD_Warning_1               : 'Pots afegir qualsevol compte per "supervisar" a la pestanya de carteres sense pujar una clau privada. Això ** no ** vol dir que tinguis accés a aquesta cartera ni que puguis transferir-ne l\'roller d\'aquesta. ',
