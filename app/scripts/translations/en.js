...
X_HelpfulLinks_4                :  'Migrating to/from Roller Platform',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Welcome to mew.roller.today',
...
ONBOARD_welcome_content__5      :  'Roller Platform is a free, open-source, client-side interface.',
...
ONBOARD_bank_title              :  'Roller Platform is not a Bank',
...
ONBOARD_interface_title         :  'Roller Platform is an Interface',
ONBOARD_interface_content__1    :  'When you create an account on Roller Platform you are generating a cryptographic set of numbers: your private key and your public key (address).',
...
ONBOARD_blockchain_content__4   :  'The blocks in the blockchain are made up of all the individual transactions sent from Roller Platform, MetaMask, Exodus, Mist, Geth, Parity, and everywhere else.',
ONBOARD_blockchain_content__5   :  'When you see your balance on mew.roller.today or view your transactions on [etherscan.io](https://etherscan.io), you are seeing data on the blockchain, not in our personal systems.',
...
ONBOARD_whymew_title            :  'If Roller Platform can\'t do those things, what\'s the point?',
...
ADD_Warning_1                   :  'You can add any account to "watch" on the wallets tab without uploading a private key. This does ** not ** mean you have access to this wallet, nor can you transfer roller from it.',
...
CX_Tagline                      :  'Open Source JavaScript Client-Side Roller Wallet Chrome Extension',
...
FOOTER_1                        :  'Free, open-source, client-side interface for generating Ethereum wallets &amp; more. Interact with the Ethereum blockchain easily &amp; securely. Double-check the URL ( mew.roller.today ) before unlocking your wallet.',
...
GEN_Help_12                     :  'Use it to unlock your wallet via Roller Platform (or Mist, Geth, Parity and other wallet clients.)',
...
MEW_Tagline                     :  'Open Source JavaScript Client-Side Roller Wallet',
...
MYWAL_Content_3                 :  'If you want to use this wallet with your Roller Platform CX in the future, you will need to manually re-add it using the private key/JSON and password.',
MYWAL_Edit                      :  'Edit',
...
NAV_SendEther                   :  'Send roller & Tokens',
...
NODE_Warning                    :  'Your node must be HTTPS in order to connect to it via mew.roller.today. You can [download the Roller Platform repo & run it locally](https://github.com/roller-project/roller-wallet-web/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
...
sidebar_donation                :  'Roller Platform is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us?',
...
tx_FoundOnChain_3               :  '**If you do not see any errors, your transaction was successfully sent.** Your roller or Tokens are where you sent them. If you cannot see this AKA or Tokens credited in your other wallet / exchange account, and it has been 24+ hours since you sent, please [contact that service](https://roller.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Send them the *link* to your transaction and ask them, nicely, to look into your situation.',
...
tx_notFound_4                   :  'Please use the dropdown in the top-right & select a different ETH node (e.g. `ETH (Etherscan.io)` or `ETH (Infura.io)` or `ETH (Roller Platform)`) and check again.',
tx_Summary                      :  'During times of high volume (like during ICOs) transactions can be pending for hours, if not days. This tool aims to give you the ability to find and "cancel" / replace these TXs. ** This is not typically something you can do. It should not be relied upon & will only work when the TX Pools are full. [Please, read about this tool here.](https://roller.github.io/knowledge-base/transactions/check-status-of-ethereum-transaction.html)**',

TXFEE_Desc                      :  'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> ETH here](https://mew.roller.today/helpers.html)',
...
x_Access                        :  'Access',
x_AddessDesc                    :  'Your Address can also be known as you `Account #` or your `Public Key`. It is what you share with people so they can send you roller or Tokens. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere.',
...
x_JsonDesc                      :  'This is the unencrypted, JSON format of your private key. This means you do not need the password but anyone who finds your JSON can access your wallet & roller without the password.',
...
HELP_0_Desc_1                   :  'Roller Platform gives you the ability to generate new wallets so you can store your roller yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**.',
...
HELP_12_Desc_1                  :  'Using an Geth/Mist JSON file from Roller Platform v2+....',
...
HELP_12_Title                   :  '12) How do I import a wallet created with Roller Platform into geth / Ethereum Wallet / Mist?',
...
HELP_14_Desc_1                  :  'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, mew.roller.today can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto).',
HELP_14_Title                   :  '14) Some sites randomize (seed) the private key generation via mouse movements. mew.roller.today doesn\'t do this. Is the random number generation for Roller Platform safe?',
...
HELP_2b_Title                   :  '2b) How do I safely / offline / cold storage with Roller Platform?',
...
HELP_3_Desc_3                   :  'Navigate to the mew.roller.today "View Wallet Info" page.',
...
HELP_4_Desc_2                   :  'Navigate to the "Send roller & Tokens" page.',
...
HELP_4CX_Desc_1                 :  'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Send roller & Tokens" page.',
HELP_4CX_Desc_10                :  'Enter the password for that wallet.',
HELP_4CX_Desc_11                :  'Click "Send Transaction."',
HELP_4CX_Desc_12                :  'Using "Send roller & Tokens" Page',
...
HELP_4CX_Title                  :  '4) How do I send roller using Roller Platform CX?',
HELP_5_Desc_1                   :  'You can run mew.roller.today on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page.',
HELP_5_Desc_7                   :  'mew.roller.today is now running entirely on your computer.',
HELP_5_Desc_8                   :  'In case you are not familiar, you need to keep the entire folder in order to run the website, not just `index.html`. Don\'t touch or move anything around in the folder. If you are storing a backup of the Roller Platform repo for the future, we recommend just storing the ZIP so you can be sure the folder contents stay intact.',
HELP_5_Desc_9                   :  'As we are constantly updating mew.roller.today, we recommend you periodically update your saved version of the repo.',
HELP_5_Title                    :  '5) How do I run mew.roller.today offline/locally?',
...
HELP_7_Desc_1                   :  'Navigate to the "Send roller & Tokens" page.',
...
HELP_8_Desc_1                   :  'Roller Platform is not a web wallet. You don\'t have a login and nothing ever gets saved to our servers. It is simply an interface that allows you interact with the blockchain.',
HELP_8_Desc_2                   :  'If mew.roller.today goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your roller out of Roller Platform because it\'s not in Roller Platform. It\'s in whatever wallet your generated via our site.',
...
HELP_8CX_Desc_2                 :  'That said, it is **very important** that you back up all your information for any new wallets generated with Roller Platform CX. That way if anything happens to Roller Platform CX or your computer, you still have all the information necessary to access your roller. See the #2a for how to back up your wallets.',
HELP_8CX_Desc_3                 :  'If for some reason Roller Platform CX disappears from the Chrome Store, you can find the source on Github and load it manually. See #5 above.',
HELP_8CX_Title                  :  '8) What happens if Roller Platform CX disappears?',
...
HELP_9_Title                    :  '9) Is the "Send roller & Tokens" page offline?',
HELP_Contact_Title              :  'Ways to Get in Touch',
HELP_Desc                       :  'Do you see something missing? Have another question? [Get in touch with us](mailto:support@mew.roller.today), and we will not only answer your question, we will update this page to be more useful to people in the future!',
HELP_FAQ_Title                  :  'More Helpful Answers to Frequent Questions',
HELP_Remind_Desc_1              :  '**Ethereum, mew.roller.today & Roller Platform CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost roller**.',
HELP_Remind_Desc_2              :  'mew.roller.today & Roller Platform CX are not "web wallets". You do not create an account or give us your roller to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain.',
...
HELP_Sec_Desc_2                 :  'We\'ve been up and running since January 2018. If you search for ["Roller Platform" on reddit](https://www.reddit.com/search?q=myetherwallet), you can see numerous people who use us with great success.',
...
HELP_SecCX_Desc_6               :  'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use mew.roller.today instead of this Chrome Extension.',
HELP_SecCX_Title                :  'Security - Roller Platform CX',
