...
MEW_Tagline                 : 'Cartera roller JavaScript de código abierto ejecutado en el cliente ',
CX_Tagline                  : 'Cartera roller JavaScript de código abierto ejecutado en el cliente extensión Chrome ',
...
ERROR_28                        :  '(error_29) **Necesitas tu archivo Keystore/JSON y la contraseña** (o clave privada) para acceder a esta cartera en el futuro. Por favor ¡guárdala y respáldala externamente! No hay modo de recuperar una cartera si no la guardas. Lee la [página de ayuda](https://mew.roller.today/#help) para instrucciones. You need this `Keystore File + Password` or the `Private Key` (next page) to access this wallet in the future. ', // 28
...
HELP_0_Desc_1               : 'MyEtherWallet te permite generar nuevas carteras para poder almacenar tu roller por tu cuenta en lugar de en una casa de cambio. Este proceso tiene lugar por completo en tu equipo, no en nuestros servidores. Por lo tanto, cuando generes una nueva cartera, **eres responsable de hacer una copia de seguridad**. ',
...
HELP_0_Desc_5               : 'Transferir roller a la nueva cartera. ',
...
HELP_4_Desc_2               : 'Ve a la página "Enviar roller y Tokens". ',
...
HELP_4CX_Desc_1             : 'Antes de nada, necesitas añadir una cartera. Una vez hecho, tienes dos opciones: la función "Enviar" del icono de la extensión de Chrome o la página "Enviar roller y Tokens". ',
...
HELP_4CX_Desc_12            : 'Utilizando la página "Enviar roller y Tokens" ',
...
HELP_10_Desc_11             : 'On your online computer, paste the signed transaction into the text field in step #3 and click "Enviar roller y Tokens". This will broadcast your transaction. ',
...
HELP_Sec_Desc_4             : 'Comprueba la URL -- Este sitio se sirve a través de GitHub y puedes ver el código fuente aquí: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) a [https://mew.roller.today](https://mew.roller.today). ',
