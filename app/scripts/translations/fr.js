...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `GAS limite` * le `prix du GAS`. [Vous pouvez convertir GWEI -> ETH ici.](https://mew.roller.today/helpers.html)',
...
NAV_SendEther               : 'Envoyer des roller et des Tokens ',
...
/* General */
x_Access                    : 'Accès ',
x_AddessDesc                : 'Aussi appelée `adresse` ou `clé publique`. C\'est ce que vous donnez aux gens pour qu\'ils puissent vous envoyer des roller ou des Tokens. Remarquez l\'icône colorée. Cette icône doit être identique quand vous entrez votre adresse quelque part.', //Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere. Cette icône est une façon simple de reconnaître votre adresse.
x_Address                   : 'Votre adresse ',
x_Cancel                    : 'Annuler ',
x_CSV                       : 'Fichier CSV (non-chiffré) ',
x_Download                  : 'Télécharger ',
x_Json                      : 'Fichier JSON (non-chiffré) ',
x_JsonDesc                  : 'C\'est la version non-chiffrée au format JSON de votre clé privée. Cela signifie que vous n\'avez pas besoin de votre mot de passe pour l\'utiliser mais que toute personne qui trouve ce JSON peut accéder à votre portefeuille et vos roller sans mot de passe. ',
...
MEW_Tagline                 : 'Portefeuille d\'roller Open Source, écrit en JavaScript',
CX_Tagline                  : 'Extension Chrome de portefeuille d\'roller Open Source JavaScript',
...
ADD_Warning_1               : 'Vous pouvez ajouter n\'importe quel compte pour l\'afficher dans l\'onglet "portefeuilles" sans uploader une clé privée. Cela ne veut **pas** dire que vous aurez accès à ce portefeuille, ni que vous pouvez transférer des roller depuis ce portefeuille. ',
...
SENDModal_Content_4         : 'NOTE : Si vous renontrez une erreur, il est très probable que vous deviez ajouter des roller à votre compte pour couvrir les coûts (en GAS) d\'envoi des Tokens. Le GAS est payé en roller.',
...
TranslatorName_1            : '[Simon P](https://mew.roller.today/?gaslimit=21000&to=0x89a18eE46b5aabC62e94b1830881887D04C687f3&value=1.0#send-transaction) ·',
...
HELP_0_Desc_5               : 'Transférez de l\'roller vers ce nouveau portefeuille.',
...
HELP_2a_Desc_2              : 'Sauvegardez l\'adresse. Vous pouvez la garder pour vous-même ou la partager avec d\'autres personnes qui, de cette manière, peuvent vous envoyer de l\'roller.',
HELP_2a_Desc_3              : 'Sauvegardez votre clef privée en plusieurs exemplaires. Ne la partagez avec personne. Votre clef privée est nécessaire pour accéder à votre roller et pour l\'envoyer ! Il existe 3 types de clef privée :',
...
HELP_3_Desc_1               : '**Avant d\'envoyer de l\'roller à votre portefeuille**, vous devez vous assurer que vous y avez accès.',
...
HELP_3_Desc_8               : 'Si vous désirez détenir une grande quantité d\'roller, nous recommandons de commencer par envoyer une petite somme depuis le nouveau portefeuille avant d\'y déposer une somme importante. Envoyez 0,001 roller vers le nouveau portefeuille, accédez-y puis envoyez ces 0,001 roller vers une autre adresse, et vérifiez que tout a fonctionné sans encombre.',

HELP_4_Title                : '4) Comment puis-je envoyer de l\'roller d\'un portefeuille vers un autre ?',
HELP_4_Desc_1               : 'Si vous désirez transférer une grande quantité d\'roller, vous devez d\'abord essayer d\'en envoyer un petit montant vers votre portefeuille pour vous assurer que tout fonctionne comme prévu.',
HELP_4_Desc_2               : 'Naviguez vers la page "Envoyer des roller et des Tokens".',
...
HELP_4CX_Title              : '4) Comment puis-je envoyer de l\'roller avec MyEtherWallet CX ?',
HELP_4CX_Desc_1             : 'D\'abord, vous devez ajouter un portefeuille. Ceci fait, deux possibilités s\'offrent à vous : la fonctionnalité "Envoi rapide" de l\'icône de l\'extension Chrome ou la page "Envoyer des roller et des Tokens".',
...
HELP_4CX_Desc_12            : 'Avec la page "Envoyer des roller et des Tokens" ',
...
HELP_8_Desc_2               : 'Si MyEtherWallet.com venait à être hors ligne, vous devrez trouver un autre moyen (comme Geth ou Ethereum Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre roller depuis MyEtherWallet parce qu\'il ne se trouve pas dans MyEtherWallet. Il est chez vous, dans le portefeuille que vous avez généré par notre site.',
...
HELP_9_Title                : '9) La page "Envoyer des roller et des Tokens" est-elle hors ligne ? ',
...
HELP_10_Desc_11             : 'Sur votre ordinateur en ligne, collez la transaction signée dans le champ texte et cliquez sur "Envoyez l\'roller". Ceci émettra votre transaction. ',
...
HELP_13_Desc_1              : 'Cela signifie que vous n\'avez pas assez d\'roller sur votre compte pour couvrir les coûts en Gas. Chaque transaction (y compris pour les tokens et les contrats) demande du Gas, et ce Gas est payé en roller. Le nombre affiché est le montant requis pour couvrir le coût de la transaction en Wei. Prenez ce nombre, divisez-le par `10^18` (soit `1000000000000000000`) et soustrayez la somme en roller que vous essayiez d\'envoyer (si vous tentiez d\'envoyer de l\'roller). Cela vous donnera le montant en roller que vous avez besoin d\'ajouter à votre compte pour effectuer cette transaction.',
...
HELP_15_Desc_1              : 'Les comptes n\'apparaissent dans un explorateur de blockchain qu\'après une activité, comme par exemple, un envoi ou une réception d\'roller.',
...
HELP_Sec_Desc_4             : 'Vérifiez l\'URL -- Ce site est servi par Github (et vous pouvez en voir le code source ici : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages)) vers [https://mew.roller.today](https://mew.roller.today).',
