...
EOS_06                          :  'Buka halaman Send roller & Tokens',
...
ONBOARD_secure_1_content__3     :  'Selalu periksa URLnya: `https://mew.roller.today`.',
...
TXFEE_Desc                  : 'Biaya TX Fee dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Jumlahnya =  `gas limit` * `gas price`. [Anda dapat mengkonversi GWEI -> ETH](https://mew.roller.today/helpers.html)',
...
NAV_SendEther               : 'Kirim roller dan Tokens ',
...
/* General */
x_Access                    : 'Akses ',
x_AddessDesc                : 'Address Anda dikenal juga sebagai `Account #` atau `Public Key` Anda. Address inilah yang diberikan kepada pihak lain agar mereka bisa mengirim roller atau Token. Pilihlah icon alamat berwarna untuk memudahkan identifikasi. Pastikan Address ini sama persis dengan yang tertulis di Dompet Kertas Anda maupun saat dipakai untuk keperluan lainnya. ',
x_Address                   : 'Alamat Anda ',
x_Cancel                    : 'Batal ',
x_CSV                       : 'File CSV (tidak ter-enkripsi) ',
x_Download                  : 'Unduh ',
x_Json                      : 'File JSON (tidak ter-enkripsi) ',
x_JsonDesc                  : 'Ini adalah "Private Key" Anda dalam format JSON yang tidak ter-enkripsi. Tidak diperlukan password dan siapapun yang memiliki JSON Anda dapat mengakses dompet dan roller Anda tanpa password. ',
...
ADD_Warning_1               : 'Akun untuk "dilihat" dapat ditambahkan tanpa menggunakan private key. Namun berarti tidak ada akses ke dompet tersebut dan transfer roller tidak bisa dilakukan. ',
...
SENDModal_Content_4         : 'CATATAN: Jika terjadi Error, kemungkinan Anda harus menambah roller ke akun Anda untuk menutup biaya gas dan pengiriman. Gas dibayar dalam roller. ',
...
ERROR_28                    : '**DIPERLUKAN File Keystore & password** (atau Private Key) untuk mengakses dompet Anda. Simpan dan backup dengan baik file ini! Tidak ada mekanisme untuk me-recover dompet jika file-nya hilang. Baca instruksi lengkapnya [di sini](https://mew.roller.today/#help). ',
...
TranslatorName_1            : '[Yos Ginting](https://mew.roller.today/?gaslimit=21000&to=0x8F646C5c215be6E0163f02Bd2eB97AFC2DF70e5c&value=1.0#send-transaction) ',
...
HELP_Remind_Desc_1          : '** Ethereum, MyEtherWallet.com & MyEtherWallet CX, dan beberapa library Javascript yang kami gunakan sedang dalam pengembangan yang aktif.** Meskipun kami telah benar-benar menguji & puluhan ribu dompet telah berhasil diciptakan oleh para pengguna di seluruh dunia, selalu ada kemungkinan bahwa sesuatu yang tidak terduga dapat terjadi yang menyebabkan ETH Anda hilang. Tolong jangan menginvestasikan lebih dari yang Anda mampu kehilangan, dan mohon berhati-hati. Jika ada sesuatu yang buruk terjadi, kami mohon maaf, tapi **kami tidak bertanggung jawab atas roller yang hilang**. ',
HELP_Remind_Desc_2          : 'MyEtherWallet.com & MyEtherWallet CX bukan "dompet web". Anda tidak membuat akun atau memberikan roller Anda untuk kami pegang. Semua data tidak pernah meninggalkan komputer/browser Anda. Kami mempermudah Anda untuk membuat, menyimpan, dan mengakses informasi Anda dan berinteraksi dengan blockchain. ',
...
HELP_0_Desc_1               : 'MyEtherWallet memberi Anda kemampuan untuk membuat dompet baru sehingga Anda dapat menyimpan roller oleh diri Anda sendiri, bukan di bursa. Proses ini dilakukan sepenuhnya di komputer Anda, bukan di server kami. Oleh karena itu, saat Anda membuat dompet baru, **Anda bertanggung jawab untuk menyimpan cadangan/backup-nya dengan aman**. ',
...
HELP_0_Desc_5               : 'Transfer roller ke dompet baru ini. ',
...
HELP_2a_Desc_2              : 'Simpan alamatnya. Anda bisa menyimpannya untuk diri sendiri atau membaginya dengan orang lain. Dengan cara itu, orang lain bisa mentransfer roller ke Anda. ',
HELP_2a_Desc_3              : 'Simpan untuk diri sendiri semua versi kunci privat. Jangan berbagi dengan orang lain. Kunci privat tersebut akan Anda diperlukan saat Anda ingin mengakses roller Anda untuk mengirimkannya! Ada 3 jenis kunci privat: ',
...
HELP_3_Desc_1               : '**Sebelum Anda mengirim roller ke dompet baru Anda**, Anda harus memastikan Anda memiliki akses ke dompet baru tersebut. ',
...
HELP_4_Title                : '4) Bagaimana cara mengirim roller dari satu dompet ke dompet lainnya? ',
...
HELP_4_Desc_2               : 'Buka halaman "Kirim roller dan Token". ',
...
HELP_4CX_Title              : '4) Bagaimana cara mengirim roller menggunakan MyEtherWallet CX? ',
HELP_4CX_Desc_1             : 'Pertama, Anda perlu menambahkan dompet. Setelah melakukannya, Anda memiliki 2 pilihan: menggunakan "QuickSend" dari ikon Chrome Extension atau menggunakan halaman "Kirim roller dan Tokens". ',
...
HELP_4CX_Desc_12            : 'Menggunakan halaman "Kirim roller dan Tokens" ',
...
HELP_8_Desc_2               : 'Jika situs MyEtherWallet.com tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Ethereum Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" roller Anda dari MyEtherWallet.com karena roller Anda tidak disimpan di MyEtherWallet.com. roller Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
...
HELP_9_Title                : '9) Kenapa halaman "Kirim roller dan Tokens" seperti offline? ',
...
HELP_13_Desc_1              : 'Ini artinya tidak tersedia cukup roller di akun Anda untuk menutupi biaya gas. Setiap transaksi (termasuk token dan transaksi kontrak) memerlukan gas dan gas tersebut dibayarkan menggunakan roller. Jumlah yang ditampilkan adalah jumlah yang dibutuhkan untuk menutupi biaya transaksi di Wei. Ambil nomor itu, bagi dengan `1000000000000000000`, dan pakai untuk mengurangi jumlah roller yang ingin Anda kirim (jika Anda mencoba mengirim Eter). Ini akan memberi Anda jumlah roller yang perlu Anda kirim ke akun tersebut untuk melakukan transaksi. ',
...
HELP_15_Desc_1              : 'Account hanya akan muncul di explorer blockchain begitu akun memiliki aktivitas di dalamnya&mdash;misalnya, setelah Anda memindahkan beberapa roller ke sana. ',
...
HELP_Sec_Desc_4             : 'Periksa URL ini -- Situs ini dijalankan melalui GitHub dan Anda bisa melihat sorce code nya di sini: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) ke [https://mew.roller.today](https://mew.roller.today). ',
