...
EOS_06                          :  'roller/トークンの送出ページに移動', /*Go to Send roller & Tokens Page*/
...
ONBOARD_secure_1_content__3     :  'いつも、必ず、ＵＲＬ：「https://mew.roller.today」を確認してください。', /*Always check the URL: `https://mew.roller.today`.*/
...
ERROR_28                    : '(error_29) お財布を操作するためには**Keystore/JSONとパスワードか秘密鍵が必要** 保存してから、外部バックアップしてください！ここで保存しないとお財布が使用できなくなります。詳細はヘルプページを参照してください。(https://mew.roller.today/#help) (You need this `Keystore File + Password` or the `Private Key` (next page) to access this wallet in the future. ) ',
...
TXFEE_Desc                  : 'この処理料金は自分の処理をブロックに配置するためにマイナーに支払われます。「ガスリミット」＊「ガス価格」で算出されます。 [GWEI -> ETHの単位変換はこちらです。](https://mew.roller.today/helpers.html)',　/*The TX Fee is paid to miners for including your TX in a block. It is the `gas limit` * `gas price`. [You can convert GWEI -> ETH here](https://mew.roller.today/helpers.html)*/
...
HELP_0_Desc_1               : 'MyEtherWallet gives you the ability to generate new wallets so you can store your roller yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**. ',
...
HELP_0_Desc_5               : 'Transfer roller to this new wallet. ',
...
HELP_2a_Desc_3              : 'Save versions of the private key. Do not share it with anyone else. Your private key is necessary when you want to access your roller to send it! There are 3 types of private keys: ',
...
HELP_3_Desc_1               : '**Before you send any roller to your new wallet**, you should ensure you have access to it. ',
...
HELP_4_Title                : '4) How do I send roller from one wallet to another? ',
...
HELP_4CX_Title              : '4) How do I send roller using MyEtherWallet CX? ',
...
HELP_8_Desc_2               : 'If MyEtherWallet.com goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your roller out of MyEtherWallet because it\'s not in MyEtherWallet. It\'s in whatever wallet your generated via our site. ',
...
HELP_8CX_Desc_2             : 'That said, it is **very important** that you back up all your information for any new wallets generated with MyEtherWallet CX. That way if anything happens to MyEtherWallet CX or your computer, you still have all the information necessary to access your roller. See the #2a for how to back up your wallets. ',
...
HELP_13_Desc_1              : 'This means you do not have enough roller in your account to cover the cost of gas. Each transaction (including token and contract transactions) require gas and that gas is paid in roller. The number displayed is the amount required to cover the cost of the transaction in Wei. Take that number, divide by `1000000000000000000`, and subtract the amount of roller you were trying to send (if you were attempting to send roller). This will give you the amount of roller you need to send to that account to make the transaction. ',
...
HELP_15_Desc_1              : 'Accounts will only show up in a blockchain explorer once the account has activity on it&mdash;for example, once you have transferred some roller to it. ',
...
HELP_Remind_Desc_1          : '**Ethereum, MyEtherWallet.com & MyEtherWallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost roller**. ',
HELP_Remind_Desc_2          : 'MyEtherWallet.com & MyEtherWallet CX are not "web wallets". You do not create an account or give us your roller to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain. ',
...
HELP_Sec_Desc_4             : 'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) to [https://mew.roller.today](https://mew.roller.today). ',
