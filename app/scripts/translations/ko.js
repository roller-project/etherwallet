...
ONBOARD_secure_1_content__3     :  'URL을 항상 확인하세요: `https://www.mew.roller.today`.',
...
TXFEE_Desc                  : 'TX 수수료는 TX를 포함한 블록을 캔 채굴자에게 지불됩니다. 이는 `가스 한도` * `가스 가격` 입니다. [GWEI단위 -> ETH단위로 변환할 수 있습니다.](https://www.mew.roller.today/helpers.html)',
...
ERROR_28                    : '(error_29) 지갑에 액세스하기 위해서는 **키스토어 파일과 비밀번호** (또는 개인키)가 필요합니다. 별도로 저장하여 백업해주세요. 만약 그것을 저장하지 않으면 지갑을 복원할 방법이 없습니다. 자세한 내용은 [도움말 페이지](https://www.mew.roller.today/#help)를 참고해주세요. ',
...
HELP_Sec_Desc_4             : '이 URL을 확인해보세요. -- 이 사이트는 GitHub를 통해 소스가 공개되어 있으며 다음 링크에서 확인하실 수 있습니다. : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) to [https://www.mew.roller.today](https://www.mew.roller.today). ',
