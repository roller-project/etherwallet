...
TXFEE_Desc                  : 'De TX vergoeding (`fee`) wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. De vergoeding is de `gas limiet` * `gas prijs`. [Je kunt hier GWEI -> ETH converteren](https://mew.roller.today/helpers.html)',
...
NAV_SendEther               : 'Verzend roller & Tokens ',
...
x_AddessDesc                : 'Je Adres wordt ook wel je `Account #` of je Publieke Sleutel ("Public Key") genoemd. Dit is wat je deelt met anderen zodat ze je roller of Tokens kunnen toesturen. Zie ook je kleurrijke adres icoon. Zorg ervoor dat het matched met je paper wallet & waar dan ook wanneer je je adres ergens invoerd. Dit icoon is een makkelijke manier om je adres te herkennen. ',
x_Address                   : 'Je Adres ',
x_Cancel                    : 'Annuleren ',
x_CSV                       : 'CSV bestand (onversleuteld) ',
x_Download                  : 'Download ',
x_Json                      : 'JSON Bestand (onversleuteld) ',
x_JsonDesc                  : 'Dit is het onversleutelde, JSON formaat van je prive sleutel ("Private Key"). Dit betekend dat je het wachtwoord niet nodig hebt, maar ook dat een ieder die je JSON bestand vind toegang heeft tot je wallet & roller zonder wachtwoord. ',
...
/* Header */
CX_Tagline                  : 'Open Source JavaScript Client-Side Roller Wallet Chrome Extensie ',
...
ADD_Warning_1               : 'Je kunt elk account toevoegen als "bekijken" in het wallets tabblad zonder de prive sleutel te uploaden. Dit betekend ** niet ** dat je toegang hebt tot deze wallet, noch dat je er roller vanuit kunt versturen. ',
...
ERROR_28                    : '**Je hebt je Keystore Bestand & wachtwoord of prive sleutel nodig** om toegang tot deze wallet te verkrijgen in de toekomst. Sla het op & maak een externe back-up! Er is geen enkele manier om je wallet te herstellen als je het nu niet opslaat. Lees ook de help pagina (https://mew.roller.today/#help) voor instructies. ',
...
TranslatorName_1            : '[h3ll0fr13nd](https://mew.roller.today/?gaslimit=21000&to=0xB5FbCE123F12347206c881cae73A3046BA1A90bA&value=1.0#send-transaction) ',
...
HELP_0_Desc_5               : 'Verzend roller naar dit nieuwe wallet. ',
...
HELP_3_Desc_1               : 'Zorg **voordat je enige roller naar je wallet verstuurd** dat je controleerd dat je er toegang toe hebt. ',
...
HELP_4_Title                : '4) Hoe stuur ik roller van het ene wallet naar het ander? ',
...
HELP_4_Desc_2               : 'Navigeer naar de "Verzend roller en Tokens" pagina. ',
...
HELP_4CX_Title              : '4) Hoe verzend ik roller met MyEtherWallet CX? ',
HELP_4CX_Desc_1             : 'Ten eerste heb je een wallet nodig. Zodra je die hebt, heb je 2 opties: De "VerzendSnel" functionaliteit vanuit het Chrome Extensie icoon of de "Verzend roller en Tokens" pagina. ',
...
HELP_4CX_Desc_12            : 'Maak gebruik van de "Verzend roller en Tokens" Pagina ',
...
HELP_9_Title                : '9) Is de "Verzend roller en Tokens" pagina offline? ',
...
HELP_13_Desc_1              : 'Dit betekend dat je account onvoldoende roller bevat om de kosten voor het vereiste gas te dekken. Elke transactie (inclusief token en contract transacties) vereisen gas en dit gas wordt betaald in roller. Het weergegeven nummer is de hoeveelheid die voor de transactie vereist in Wei. Neem dit nummer, deel het door `1000000000000000000`, en trek daarvan de hoeveelheid roller die je probeerde te verzenden af (als je probeerde roller te versturen). Dit geeft je de hoeveelheid roller die je dient te versturen naar het account om de transactie te maken. ',
...
HELP_15_Desc_1              : 'Adresen zullen enkel in een blockchain explorer worden weergegeven zodra er activiteit op een account heeft plaats gevonden. Bijvoorbeeld, zodra je er wat roller naar toe verzonden hebt. ',
...
HELP_Sec_Desc_4             : 'Controleer de URL -- Deze website draait vanaf GitHub en je kunt de bron code hier vinden: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) naar de domein namen: [https://mew.roller.today](https://mew.roller.today). ',
