...
TXFEE_Desc                  : 'Transaksjonsavgiften betales til "utgraverne" for å inkludere transaksjonen din i en blokk. Det er `gas-grense` * `gas-pris`. [Du kan regne om GWEI -> ETH her](https://mew.roller.today/helpers.html)',
...
/* General */
x_Access                    : 'Åpne ',
x_AddessDesc                : 'Din `adresse` kalles også for `kontonummer` eller `offentlig nøkkel`. Det er denne du sender til folk så de kan sende deg roller eller Tokens. Find det fargerike adresse-ikonet. Forsikre deg om at det er likt med ikonet på papir-lommeboken din og ellers hver gang du oppgir adressen din. ',
...
MEW_Tagline                 : 'Open Source JavaScript Client-Side Roller Wallet ', /* Intentionally not translated */
CX_Tagline                  : 'Open Source JavaScript Client-Side Roller Wallet Chrome Extension ', /* Intentionally not translated */
...
ERROR_28                    : '**Du trenger din Keystore-fil & passord eller din private nøkkel** for å få tilgang til denne lommeboken i framtiden. Vennligst lagre og sikkerhetskopier den eksternt! Det finnes ingen måte å gjenopprette en lommebok på hvis du ikke lagrer den. Les [hjelpesiden](https://mew.roller.today/#help) for ytterligere instruksjoner (foreløpig kun på engelsk). ',
...
TranslatorName_1            : '[mrstormlars](https://mew.roller.today/?gaslimit=21000&to=mrstormlars.eth&value=1.0#send-transaction) ',
TranslatorAddr_1            : '',
...
HELP_1_Desc_1               : 'Gå til "Send roller & Tokens"-siden. ',
...
HELP_4_Desc_2               : 'Naviger til "Send roller & Tokens"-siden. ',
...
HELP_4CX_Desc_1             : 'Først må du legge til en lommebok. Når du har gjort det, har du 2 muligheter: den kjappe "Send"-funksjonaliteten fra Chrome-utvidelsesikonet eller "Send roller & Tokens"-siden. ',
...
HELP_4CX_Desc_12            : 'Bruk "Send roller & Tokens"-siden ',
...
HELP_7_Desc_1               : 'Naviger til "Send roller & Tokens"-siden. ',
...
HELP_9_Title                : '9) Er "Send roller & Tokens"-siden offline? ',
...
HELP_10_Desc_11             : 'Lim inn den signerte transaksjonen i tekstfeltet i steg #3 på den tilkoblede maskinen og klikk "Send roller & Tokens". Dette vil kringkaste transaksjonen din. ',
...
HELP_13_Desc_1              : 'Dette betyr at du ikke har nok roller på kontoen din til å dekke gas-kostnaden. Hver transaksjon (inkludert token- og kontrakt-transaksjoner) krever gas, og gas betales med roller. Tallet som vises er beløpet som kreves for å dekke transaksjonskostnaden i Wei (1 ETH = 10^18 Wei). Ta dette tallet, del det på `1000000000000000000`, og trekk fra roller-beløpet som du prøvde å sende (hvis du prøvde å sende roller). Dette vil gi deg roller-beløpet som du mangler på (trenger å sende til) denne kontoen for å gjennomføre transaksjonen. ',
...
HELP_15_Desc_1              : 'Kontoer vil kun dukke opp i en blokkjede-utforsker når kontoen har hatt aktivitet&mdash;for eksempel, når du har overført roller til den. ',
...
HELP_21_Title               : '21) Kan ikke hvem som helst legge inn tilfeldige private nøkler, sjekke saldoen, og sende roller til sin egen adresse? ',
HELP_21_Desc_1              : 'Kortversjonen: ja, men å finne en konto som inneholder roller ville tatt lengre tid enn universets levealder...så...nei. ',
...
HELP_Sec_Desc_3             : 'Vi kommer ikke til å ta pengene dine eller stjele dine private nøkler. Det er ingen ondsinnet kode på denne siden. Faktisk er "Send roller & Tokens"-siden fullstendig klient-drevet. Det betyr at all koden blir kjørt på ** din datamaskin ** og det blir aldri lagret eller overført noe sted. ',
HELP_Sec_Desc_4             : 'Sjekk nettsideadressen (URL) -- Denne siden blir drevet gjennom GitHub og du kan se kildekoden her: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) til domenet: [https://mew.roller.today](https://mew.roller.today). ',
