...
TXFEE_Desc                  : 'Transaksjonsavgiften betales til "utgraverne" for å inkludere transaksjonen din i en blokk. Det er `gas-grense` * `gas-pris`. [Du kan regne om GWEI -> ETH her](https://www.mew.roller.today/helpers.html)',
...
ERROR_28                    : '**Du trenger din Keystore-fil & passord eller din private nøkkel** for å få tilgang til denne lommeboken i framtiden. Vennligst lagre og sikkerhetskopier den eksternt! Det finnes ingen måte å gjenopprette en lommebok på hvis du ikke lagrer den. Les [hjelpesiden](https://www.mew.roller.today/#help) for ytterligere instruksjoner (foreløpig kun på engelsk). ',
...
TranslatorName_1            : '[mrstormlars](https://www.mew.roller.today/?gaslimit=21000&to=mrstormlars.eth&value=1.0#send-transaction) ',
TranslatorAddr_1            : '',
...
HELP_Sec_Desc_4             : 'Sjekk nettsideadressen (URL) -- Denne siden blir drevet gjennom GitHub og du kan se kildekoden her: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) til domenet: [https://www.mew.roller.today](https://www.mew.roller.today). ',
