...
NAV_SendEther               : 'Wyślij roller i Tokeny ',
...
ERROR_28                    : '**Potrzebujesz plik Keystore i hasło, lub Klucz Prywatny** aby uzyskać dostęp do tego portfela w przyszłości. Wykonaj zewnętrzną kopię bezpieczeństwa! Nie ma możliwości odzyskania portfela jeżeli go nie zapiszesz. Wejdź na [stronę pomocy](https://mew.roller.today/#help) po instrukcje. ',
...
HELP_4_Title                : '4) Jak wysłać roller z jednego portfela na inny? ',
...
HELP_4_Desc_2               : 'Przejdź na zakładkę "Wyślij roller". ',
...
HELP_4CX_Title              : '4)Jak wysłać roller używając MyEtherWallet CX? ',
HELP_4CX_Desc_1             : 'Najpierw musisz dodać portfel. Po dodaniu portfela masz 2 możliwości do wyboru: funkcja "Wyślij" z ikony Rozszerzenia Chrome lub zakładka "Wyślij roller" ze strony "Moje Portfele". ',
...
HELP_4CX_Desc_12            : 'Używając zakładki "Wyślij roller" ',
...
HELP_7_Desc_1               : 'Przejdź na zakładkę "Wyślij roller i Tokeny". ',
...
HELP_9_Title                : '9) Czy zakładka "Wyślij roller" działa offline? ',
...
HELP_13_Desc_1              : 'Oznacza to, że nie posiadasz wystarczającej ilości roller na koncie, aby pokryć koszty paliwa. Każda transakcja (przesyłanie tokenów lub interakcja z kontraktem) wymaga paliwa, które jest opłacane w roller\'ach. Wyświetlona wartość jest ilością potrzebną na pokrycie kosztów transakcji w Wei\'ach. Podziel tą liczbę przez `1000000000000000000` i odejmij wartość roller, którą chciałeś wysłać (jeśli wysyłałeś roller). Otrzymasz wartość, jaką musisz przesłać na swoje konto, aby wykonać transakcję.',
...
HELP_Sec_Desc_4             : 'Sprawdź adres URL -- Ta strona jest serwowana przez GitHub. Kod źródłowy jest dostępny pod: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Strona jest dostępna pod domenami: [https://mew.roller.today](https://mew.roller.today). ',
