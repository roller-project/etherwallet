...
NAV_SendEther               : 'Enviar roller & Tokens ',
...
MEW_Tagline                 : 'Fonte aberta JavaScript para o client-side da Carteira roller ',
CX_Tagline                  : 'Fonte Aberta JavaScript para o client-side da Carteira roller para extensão do Chrome ',
...
ADD_Warning_1               : 'Você pode adicionar qualquer conta para "ver" na tab de carteiras sem fazer o upload da chave privada. Isso significa que você ** não **  tem acesso a essa carteira, nem pode transferir roller a partir dela. ',
...
ERROR_28                    : '**Você precisa do seu arquivo de armazenamento de chaves & senha** (ou Chave Privada) para acessar essa carteira no futuro. Por favor, salve e armazene ela externamente! Não há como recuperar uma carteira se você não salvar isso. Leia a [página de ajuda](https://mew.roller.today/#help) para instruções. ',
...
TranslatorName_1            : '[ Pedro "ShooterXD" Vieira ](https://mew.roller.today/?gaslimit=21000&to=0x24eB7d82166361A8B69adE6FEA187Cb00FD7c7E1&value=1.0#send-transaction) ',
TranslatorAddr_1            : '',
...
HELP_4_Desc_2               : 'Navigate to the "Enviar roller & Tokens" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Enviar roller & Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Enviar roller & Tokens" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Enviar roller & Tokens" page. ',
...
HELP_9_Title                : '9) Is the "Enviar roller & Tokens" page offline? ',
