...
TXFEE_Desc                  : 'ค่าธรรมเนียมธุรกรรม (TX) จะถูกจ่ายให้กับผู้ขุดที่ขุด TX ของคุณลงในบล็อค มีค่าเท่ากับ `จำนวนจำกัดแก๊ส` * `ราคาแก๊ส` [คุณสามารถแปลง GWEI -> ETH ได้ที่นี่](https://www.mew.roller.today/helpers.html)',
...
TranslatorName_1            : '[Tianissimo (Suteepat)](https://www.mew.roller.today/?gaslimit=21000&to=0x8d0a185C16ADE28bf69Cb38c5e3df605360df40e&value=1.0#send-transaction) ',
