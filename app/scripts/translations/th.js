...
TXFEE_Desc                  : 'ค่าธรรมเนียมธุรกรรม (TX) จะถูกจ่ายให้กับผู้ขุดที่ขุด TX ของคุณลงในบล็อค มีค่าเท่ากับ `จำนวนจำกัดแก๊ส` * `ราคาแก๊ส` [คุณสามารถแปลง GWEI -> ETH ได้ที่นี่](https://mew.roller.today/helpers.html)',
...
NAV_SendEther               : 'ส่ง roller & Token ',
...
/* General */
x_Access                    : 'เข้าใช้ ',
x_AddessDesc                : 'ที่อยู่ของคุณ หรือสามารถเรียกอีกอย่างว่า `Account #` หรือ `กุญแจสาธารณะ (Public Key)` คือสิ่งที่คุณสามารถแชร์ให้ผู้อื่น เพื่อรอรับ roller หรือ Token ได้ เพียงมองหาไอคอนของที่อยู่และตรวจสอบให้แน่ใจว่ามันตรงกับกระเป๋ากระดาษของคุณ หรือเมื่อใดก็ตามที่คุณป้อนที่อยู่ของคุณ',
x_Address                   : 'ที่อยู่ของคุณ ',
x_Cancel                    : 'ยกเลิก ',
x_CSV                       : 'ไฟล์ CSV (ไม่ได้ถูกเข้ารหัส) ',
x_Download                  : 'ดาวน์โหลด ',
x_Json                      : 'ไฟล์ JSON (ไม่ได้ถูกเข้ารหัส) ',
x_JsonDesc                  : 'เนื้่อหานี้ไม่ถูกเข้ารหัส ซึ่งเป็น กุญแจส่วนตัว (Private Key) ของคุณที่อยู่รูปแบบ JSON ซึ่งหมายความว่าผู้อื่นที่เข้าถึง JSON นี้ จะสามารถเข้าถึงกระเป๋า & roller ของคุณได้โดยไม่จำเป็นต้องรู้รหัสผ่านเลย ',
...
/* Header */
CX_Tagline                  : 'โอเพ่นซอร์ส JavaScript ฝั่งไคลเอนต์สำหรับสร้างกระเป๋า roller ผ่าน Chrome Extension ',
...
MEW_Tagline                 : 'โอเพ่นซอร์ส JavaScript ฝั่งไคลเอนต์สำหรับสร้างกระเป๋า roller ',
...
ADD_Warning_1               : 'คุณสามารถเพิ่มบัญชีเข้า "รายการติดตาม" จากแท็บของกระเป๋าโดยไม่ต้องอัพโหลด private key ซึ่งการกระทำนี้ ** ไม่ได้ ** หมายความว่าคุณสามารถเข้าถึงกระเป๋านี้ได้ หรือสามารถส่ง roller ออกจากกระเป๋าได้ ',
...
SENDModal_Content_4         : 'หมายเหตุ: หากคุณพบข้อผิดพลาด โดยส่วนใหญ่แล้วคุณจำเป็นที่จะต้องเพิ่ม roller เข้าบัญชีเพื่อใช้เป็นค่าแก๊สในการส่ง Token และค่าแก๊สจะถูกจ่ายด้วย roller ',
...
TranslatorName_1            : '[Tianissimo (Suteepat)](https://mew.roller.today/?gaslimit=21000&to=0x8d0a185C16ADE28bf69Cb38c5e3df605360df40e&value=1.0#send-transaction) ',
